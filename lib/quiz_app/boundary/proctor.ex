defmodule QuizApp.Boundary.Proctor do
  use GenServer
  require Logger
  ...
  defp append_state(tuple, quizzes), do: Tuple.insert_at(tuple, tuple_size(tuple), quizzes)
  ...
  defp maybe_append_timeout(tuple, quizzes, now) do
    ...
    Tuple.insert_at(tuple, tuple_size(tuple), timeout)
  end
end
