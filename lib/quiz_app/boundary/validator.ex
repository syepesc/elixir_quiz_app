defmodule QuizApp.Boundary.Validator do
  @moduledoc """
  Using ecto changeset was out of scope for this book example thoug are recommended.
  Instead, we use this simple validator.
  """
