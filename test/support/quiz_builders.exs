defmodule QuizBuilders do
  ...
  defmacro __using__(_opts) do
    quote do
      alias QuizApp.Core.{Template, Response, Quiz}
  ...
  @spec double_digits() :: list(integer())
  def double_digits() do
    Enum.to_list(10..99)
  end

  @spec single_digits() :: list(integer())
  ...
  def quiz_fields(overrides) do
    Keyword.merge([title: "Simple Arithmetics"], overrides)
  end
